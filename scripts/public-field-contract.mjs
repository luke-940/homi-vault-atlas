...
const exactRules = new Map([
  ...
  ["meaning", fields("schema profile generatedAt baseline current domainBackbone connectionStories protagonists constellations movements operationalCompass scenes manifest")],
  ...
  ["meaning.domainBackbone[]", fields("id domain districtId anchorNodeId edgeIds statement evidenceGap")],
  ["meaning.connectionStories[]", fields("id focalNodeId thesis edgeIds incomingEdgeIds outgoingEdgeIds domainIds caveat label")],
  ["meaning.protagonists[]", fields("id nodeId role thesis caveat metrics evidenceRefs selectionMode storyIds")],
  ...
  ["meaning.manifest", fields("protagonistCount constellationCount movementCount storyCount actualUsedEdgeCount domainCoverage projectionDigest")],
...
const primitiveRecordPaths = new Set([
  ...
  "meaning.manifest.domainCoverage",
