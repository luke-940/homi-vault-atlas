...
import { stableDigest } from "./lib/profile-contract.mjs";
...
const outputDir = requiredPathEnvironment("ATLAS_CAPTURE_DIR");
...
if (!insideOrEqual(configuredOutputRoot, outputDir)) {
  throw new Error("Capture blocked: ATLAS_CAPTURE_DIR must remain under ATLAS_BUILDER_OUTPUT_ROOT.");
}
