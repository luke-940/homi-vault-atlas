...
export function createPublicPackageManifest(sourcePackage) {
  return {
    ...
    scripts: {
      ...
      "test:public": "ATLAS_TEST_PROFILE=public-ci vitest run tests-public tests/v7-6-qa-contract.test.ts tests/visual-golden-contract.test.ts --maxWorkers=1",
      ...
      "release:evidence": "node scripts/create-v7-6-release-evidence-inventory.mjs",
      "release:readback": "node scripts/readback-production.mjs",
      "qa:local": "ATLAS_QA_MODE=dev node scripts/run-v7-6-qa.mjs",
      "qa:file": "ATLAS_QA_MODE=file-smoke node scripts/run-v7-6-qa.mjs",
      "qa:ci": "ATLAS_QA_MODE=ci node scripts/run-v7-6-qa.mjs",
      "qa:visual:manifest": "node scripts/verify-v7-6-visual-golden.mjs",
